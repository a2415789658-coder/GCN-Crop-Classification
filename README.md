...
This application uses advanced techniques in deep learning and remote sensing to identify and classify different types of crops. It leverages Graph Convolutional Networks, providing you with a reliable tool to assist in agricultural assessments.

### 📋 System Requirements
Before you begin, here are the requirements you need to meet:

- **Operating System**: Windows 10, macOS, or Linux
- **Python Version**: Python 3.6 or later
- **Memory**: At least 8 GB RAM
- **Storage**: 1 GB of free disk space
- **Internet Connection**: Required for initial download and demo access
...
### 🔥 Features
- **High Accuracy**: Achieves 99.9% accuracy in crop classification.
- **User-Friendly Interface**: Designed for ease of use, even for non-technical users.
- **Interactive Demo**: Test the application using a browser-based interface without any installations.
...
2. You will see options to either upload an image or use the demo.
3. If you want to test with your own image, upload a Sentinel-2 image of your choice.
4. Click the "Classify" button to start the classification process.
5. Review the results displayed on the interface. You will see the type of crop identified and the confidence level.
